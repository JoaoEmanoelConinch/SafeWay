	...
	<div id="main-container">
		...
		<form id="register-form" action="inserir-usuario" method="POST">
			...
			<div class="full-box">
				...
				<input type="password" name="senha" id="senha" minlength="8" maxlength="45" placeholder="Digite sua senha" minlength="8" maxlength="45" placeholder="Digite sua senha" required>
			</div>

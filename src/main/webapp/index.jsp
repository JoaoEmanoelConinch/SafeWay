...
<body>
  ...
  <div class="absolute" id="logo">
   ...
   <div  id="invisivel">
    ...
    <a class="bt-inicial" href="<%=request.getContextPath()%>/cadastro"  id="cadastre-se">Cadastre-se</a><br><br>
    
    
    
  
  
        <a class="bt-inicial" href="<%=request.getContextPath()%>/login" id="logar">Logar</a>
     </div>
     </div>
 </div> 

  ...
  <div id="main-container">
    ...
    <form id="register-form" action="inserir-Usuario" method="POST" >
      <div class="full-box">
          ...
          <input type="text" name="name" id="nome" placeholder="Digite seu nome" data-required data-min-length="3" data-max-length="40">
      </div>
      <div class="full-box">
      ...
      <div class="full-box">
        ...
        <input type="password" name="password" id="senha" minlength="8" maxlength="45" placeholder="Digite sua senha" data-password-validate data-required>
      </div>
      <div class="full-box">
